...
images = glob.glob(r'E:\Coding\Python\DepthAnything\2d_3d\calibration_images_fixed_position\*.png')  # Update with the path to your images
...
np.savez(
    r"E:\Coding\Python\DepthAnything\image-to-pcd\CalibrationMatrix_college_cpt_basler_4mm",
    Camera_matrix=mtx,
    distCoeff=dist,
    RotationalV=rvecs,
    TranslationV=tvecs
