...
calibration_data = np.load(r"E:\Coding\Python\DepthAnything\image-to-pcd\CalibrationMatrix_college_cpt_basler_4mm.npz")
...
NYU_DATA = False
INPUT_DIR = r"E:\Coding\Python\DepthAnything\2d_3d\cityhawkdata\left_cam"
OUTPUT_DIR = os.path.join(INPUT_DIR,"depthanything")
...
if __name__ == '__main__':
    model = 'zoedepth'
    # pretrained_resource = r'c:\Users\oculo\Desktop\Eswar\DepthAnything\image-to-pcd\depth_anything_metric_depth_outdoor.pt'
